...
#. În dosarul *src/main/java* creați pachetul *fruitmgr* (clic dreapta și *New > Package*).
...
#. Treceți in clasa *Fruit* și aplicați pe aceasta adnotarea :code:`@Entity`, imediat IDEA vă va propune o listă de pache de unde s-o importați alegeți :code:`javax.persistence`.
...
#. În ferestra de dialog alegeți toate trei atribute apoi clic pe *OK*. 
